...
$(function () {
  $.get('http://9943c5a38b72.c5ee2f76.hbtn-cod.io:5001/api/v1/status/', function (data, textStatus) {
    if (data.status === 'OK') {
      $('div#api_status').addClass('available');
      $.ajax({
        type: 'POST',
        contentType: 'application/json',
        url: 'http://9943c5a38b72.c5ee2f76.hbtn-cod.io:5001/api/v1/places_search/',
        dataType: 'json',
